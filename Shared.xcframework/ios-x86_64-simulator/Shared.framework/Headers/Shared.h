...
@class SharedBoundingBox, SharedStringTransformation, SharedStringTransformationDelete, SharedStringTransformationInsert, SharedStringTransformationKeep, SharedStringTransformationReplace, SharedURLDetectionResultDetectedURL, SharedURLDetectionResult, SharedFrame, SharedFrameOcrResultDetection, SharedFrameOcrResult, SharedFrameOcrResultSuccess, SharedPhishingDetectorResult, SharedExecutor<T>, SharedPhishingDetectorResultAuthentic, SharedPhishingDetectorResultPhishing, SharedPhishingDetectorResultUnknown, NSObject, UIImage, SharedKotlinThrowable, SharedKotlinArray<T>;
...
__attribute__((swift_name("CommandVisitor")))
@protocol SharedCommandVisitor
@required
- (void)visitDeleteCommandValue:(id _Nullable)value __attribute__((swift_name("visitDeleteCommand(value:)")));
- (void)visitInsertCommandValue:(id _Nullable)value __attribute__((swift_name("visitInsertCommand(value:)")));
- (void)visitKeepCommandValue:(id _Nullable)value __attribute__((swift_name("visitKeepCommand(value:)")));
@end;
...
__attribute__((swift_name("URLDetectionResult")))
@interface SharedURLDetectionResult : SharedBase
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("URLDetectionResult.DetectedURL")))
@interface SharedURLDetectionResultDetectedURL : SharedBase
...
- (SharedURLDetectionResultDetectedURL *)doCopyURL:(NSString *)URL __attribute__((swift_name("doCopy(URL:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("URLDetectionResult.MoreThanOneURLDetected")))
@interface SharedURLDetectionResultMoreThanOneURLDetected : SharedURLDetectionResult
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)moreThanOneURLDetected __attribute__((swift_name("init()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("URLDetectionResult.NoURLBarDetected")))
@interface SharedURLDetectionResultNoURLBarDetected : SharedURLDetectionResult
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)noURLBarDetected __attribute__((swift_name("init()")));
@end;

__attribute__((swift_name("URLDetector")))
@protocol SharedURLDetector
@required
...
- (void)registerCallbackCallback:(void (^)(SharedURLDetectionResult *))callback __attribute__((swift_name("registerCallback(callback:)")));
@end;
